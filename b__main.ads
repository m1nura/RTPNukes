...
package ada_main is
   ...
   u00023 : constant Version_32 := 16#d90dc63e#;
   ...
   u00025 : constant Version_32 := 16#7a71e7d2#;
   ...
   u00032 : constant Version_32 := 16#472c9584#;
   ...
   u00038 : constant Version_32 := 16#f4957a4a#;
   ...
   u00047 : constant Version_32 := 16#60740d3a#;
   pragma Export (C, u00047, "system__wch_jisS");
   u00048 : constant Version_32 := 16#769e25e6#;
   pragma Export (C, u00048, "interfaces__cB");
   u00049 : constant Version_32 := 16#4a38bedb#;
   pragma Export (C, u00049, "interfaces__cS");
   u00050 : constant Version_32 := 16#f4bb3578#;
   pragma Export (C, u00050, "system__os_primitivesB");
   u00051 : constant Version_32 := 16#441f0013#;
   pragma Export (C, u00051, "system__os_primitivesS");
   u00052 : constant Version_32 := 16#0881bbf8#;
   pragma Export (C, u00052, "system__task_lockB");
   u00053 : constant Version_32 := 16#9544bb54#;
   pragma Export (C, u00053, "system__task_lockS");
   u00054 : constant Version_32 := 16#1716ff24#;
   pragma Export (C, u00054, "system__win32S");
   u00055 : constant Version_32 := 16#1a9147da#;
   pragma Export (C, u00055, "system__win32__extS");
   u00056 : constant Version_32 := 16#ee80728a#;
   pragma Export (C, u00056, "system__tracesB");
   u00057 : constant Version_32 := 16#06d3e490#;
   pragma Export (C, u00057, "system__tracesS");
   u00058 : constant Version_32 := 16#84ad4a42#;
   pragma Export (C, u00058, "ada__numericsS");
   u00059 : constant Version_32 := 16#91613c5c#;
   pragma Export (C, u00059, "ada__real_timeB");
   u00060 : constant Version_32 := 16#87ade2f4#;
   pragma Export (C, u00060, "ada__real_timeS");
   u00061 : constant Version_32 := 16#1f99af62#;
   pragma Export (C, u00061, "system__arith_64B");
   u00062 : constant Version_32 := 16#d4b08bf7#;
   pragma Export (C, u00062, "system__arith_64S");
   u00063 : constant Version_32 := 16#30bb6e97#;
   pragma Export (C, u00063, "system__taskingB");
   u00064 : constant Version_32 := 16#8d6ada58#;
   pragma Export (C, u00064, "system__taskingS");
   u00065 : constant Version_32 := 16#01715bc2#;
   pragma Export (C, u00065, "system__task_primitivesS");
   u00066 : constant Version_32 := 16#f4bb5b54#;
   pragma Export (C, u00066, "system__os_interfaceS");
   u00067 : constant Version_32 := 16#2c7d263c#;
   pragma Export (C, u00067, "interfaces__c__stringsB");
   u00068 : constant Version_32 := 16#603c1c44#;
   pragma Export (C, u00068, "interfaces__c__stringsS");
   u00069 : constant Version_32 := 16#e2725713#;
   pragma Export (C, u00069, "system__task_primitives__operationsB");
   u00070 : constant Version_32 := 16#12291044#;
   pragma Export (C, u00070, "system__task_primitives__operationsS");
   u00071 : constant Version_32 := 16#1b28662b#;
   pragma Export (C, u00071, "system__float_controlB");
   u00072 : constant Version_32 := 16#1432cf06#;
   pragma Export (C, u00072, "system__float_controlS");
   u00073 : constant Version_32 := 16#da8ccc08#;
   pragma Export (C, u00073, "system__interrupt_managementB");
   u00074 : constant Version_32 := 16#c90ea50e#;
   ...
   u00076 : constant Version_32 := 16#cc621349#;
   pragma Export (C, u00076, "system__multiprocessorsS");
   u00077 : constant Version_32 := 16#77769007#;
   pragma Export (C, u00077, "system__task_infoB");
   u00078 : constant Version_32 := 16#232885cd#;
   pragma Export (C, u00078, "system__task_infoS");
   u00079 : constant Version_32 := 16#ab9ad34e#;
   pragma Export (C, u00079, "system__tasking__debugB");
   u00080 : constant Version_32 := 16#f1f2435f#;
   ...
   u00110 : constant Version_32 := 16#84a27f0d#;
   pragma Export (C, u00110, "interfaces__c_streamsB");
   u00111 : constant Version_32 := 16#8bb5f2c0#;
   ...
   u00117 : constant Version_32 := 16#bb3cffaa#;
   pragma Export (C, u00117, "system__finalization_rootS");
   u00118 : constant Version_32 := 16#ee0f26dd#;
   pragma Export (C, u00118, "system__os_libB");
   u00119 : constant Version_32 := 16#d7b69782#;
   pragma Export (C, u00119, "system__os_libS");
   u00120 : constant Version_32 := 16#1a817b8e#;
   pragma Export (C, u00120, "system__stringsB");
   u00121 : constant Version_32 := 16#8a719d5c#;
   pragma Export (C, u00121, "system__stringsS");
   u00122 : constant Version_32 := 16#09511692#;
   pragma Export (C, u00122, "system__file_control_blockS");
   u00123 : constant Version_32 := 16#00d4719c#;
   pragma Export (C, u00123, "consoleB");
   u00124 : constant Version_32 := 16#955fa32d#;
   pragma Export (C, u00124, "consoleS");
   u00125 : constant Version_32 := 16#eea55241#;
   pragma Export (C, u00125, "sensor_systemB");
   u00126 : constant Version_32 := 16#ff34cc2a#;
   pragma Export (C, u00126, "sensor_systemS");
   u00127 : constant Version_32 := 16#9c7cdfe9#;
   pragma Export (C, u00127, "cooling_system_componentB");
   u00128 : constant Version_32 := 16#bdfca2ad#;
   pragma Export (C, u00128, "cooling_system_componentS");
   u00129 : constant Version_32 := 16#08015499#;
   pragma Export (C, u00129, "reactor_componentB");
   u00130 : constant Version_32 := 16#606551c4#;
   pragma Export (C, u00130, "reactor_componentS");
   u00131 : constant Version_32 := 16#39a3d103#;
   pragma Export (C, u00131, "typedefsS");
   ...
   u00138 : constant Version_32 := 16#f0df9003#;
   pragma Export (C, u00138, "system__img_realB");
   u00139 : constant Version_32 := 16#3366ddd8#;
   pragma Export (C, u00139, "system__img_realS");
   u00140 : constant Version_32 := 16#f05937c9#;
   pragma Export (C, u00140, "system__fat_llfS");
   u00141 : constant Version_32 := 16#f1f88835#;
   pragma Export (C, u00141, "system__img_lluB");
   u00142 : constant Version_32 := 16#205f2839#;
   pragma Export (C, u00142, "system__img_lluS");
   u00143 : constant Version_32 := 16#eef535cd#;
   pragma Export (C, u00143, "system__img_unsB");
   u00144 : constant Version_32 := 16#f662140d#;
   pragma Export (C, u00144, "system__img_unsS");
   u00145 : constant Version_32 := 16#a4beea4d#;
   pragma Export (C, u00145, "system__powten_tableS");
   u00146 : constant Version_32 := 16#faa9a7b2#;
   pragma Export (C, u00146, "system__val_realB");
   u00147 : constant Version_32 := 16#0ae7fb2b#;
   pragma Export (C, u00147, "system__val_realS");
   u00148 : constant Version_32 := 16#6c05c057#;
   pragma Export (C, u00148, "system__exn_llfB");
   u00149 : constant Version_32 := 16#48b037e6#;
   pragma Export (C, u00149, "system__exn_llfS");
   u00150 : constant Version_32 := 16#acbb902e#;
   pragma Export (C, u00150, "system__fat_fltS");
   u00151 : constant Version_32 := 16#7245d6be#;
   pragma Export (C, u00151, "steam_generator_componentB");
   u00152 : constant Version_32 := 16#243e4109#;
   pragma Export (C, u00152, "steam_generator_componentS");
   u00153 : constant Version_32 := 16#216aa6ef#;
   pragma Export (C, u00153, "system__random_numbersB");
   u00154 : constant Version_32 := 16#0d50ccf7#;
   pragma Export (C, u00154, "system__random_numbersS");
   u00155 : constant Version_32 := 16#7cd2c459#;
   pragma Export (C, u00155, "system__random_seedB");
   u00156 : constant Version_32 := 16#95585536#;
   pragma Export (C, u00156, "system__random_seedS");
   u00157 : constant Version_32 := 16#2bce1226#;
   pragma Export (C, u00157, "system__memoryB");
   u00158 : constant Version_32 := 16#adb3ea0e#;
